...
TG_TOKEN = '6891709315:AAERMjy8mAQqwQKMJosH3ywmnle-GX794w4'
                        ...
                        'requests': [
                            {
                                'deleteDimension': {
                                    'range': {
                                         'sheetId': 0 ,  # Adjust this based on your sheet names
                                        'dimension': 'ROWS',
                                        'startIndex': i,
                                        'endIndex': i + 1,
                                    },
...
def cancel_booking(user_id, phone, selected_service, existing_entry):
    ...
    # Remove the entry from the sheet if found
    if existing_entry_index is not None:
        ...
        bot.sendMessage(user_id, "Booking canceled successfully.")
